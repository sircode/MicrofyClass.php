...
// microfy_aliases.php - Auto-generated procedural aliases

if (!function_exists('getR')) {
    function getR(...$args)
    {
        return Microfy::getArray(...$args);
    }
}
if (!function_exists('v')) {
    function v(...$args)
    {
        return Microfy::v(...$args);
    }
}
...
if (!function_exists('inputVars')) {
    function inputVars(...$args)
    {
        return Microfy::inputVars(...$args);
    }
}
...
if (!function_exists('getVarsPrefixed')) {
    function getVarsPrefixed(...$args)
    {
        return Microfy::getVarsPrefixed(...$args);
    }
}
if (!function_exists('inputAll')) {
    function inputAll(...$args)
    {
        return Microfy::inputAll(...$args);
    }
}
...
if (!function_exists('extractVars')) {
    function extractVars(...$args)
    {
        return Microfy::extractVars(...$args);
    }
}
...
if (!function_exists('rPp')) {
    function rPp(...$args)
    {
        return Microfy::rPp(...$args);
    }
}
if (!function_exists('erPp')) {
    function erPp(...$args)
    {
        return Microfy::erPp(...$args);
    }
}
...
if (!function_exists('rPd')) {
    function rPd(...$args)
    {
        return Microfy::rPd(...$args);
    }
}
